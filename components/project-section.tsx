...
const staticProjects: GitHubRepo[] = [
	{
		id: 1,
		name: "wa-gateway",
		description: "API gateway to send messages and media to WhatsApp using whatsapp-web.js.",
	...
	},
	{
		...
		description: "Go-based authentication service with OAuth integration for Google and GitHub.",
	...
	},
	{
		id: 3,
		name: "ComicHive",
		description: "Open-source platform for reading manga and manhwa without ads.",
	...
	},
	{
		id: 4,
		name: "config",
		description: "Personal dotfiles for Arch Linux with BSPWM and Neovim configurations.",
		html_url: "https://github.com/rafia9005/config",
		homepage: null,
		stargazers_count: 0,
		forks_count: 0,
		language: "Shell",
		topics: ["dotfiles", "linux", "arch"],
	},
	{
		id: 5,
		name: "Dotfiles.me",
		description: "Portfolio website built with Next.js, TypeScript, and TailwindCSS.",
		html_url: "https://github.com/rafia9005/Dotfiles.me",
		homepage: "https://dotfiles.me",
		stargazers_count: 0,
		forks_count: 0,
		language: "TypeScript",
